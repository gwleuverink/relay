...
<div class="relative min-h-screen bg-neutral-100 text-xs">
    <div class="fixed left-0 right-0 top-0 z-10 grid h-7 border border-b border-b-neutral-300/40 bg-gradient-to-r from-neutral-100 to-neutral-200 pt-0.5 font-semibold text-neutral-500 shadow-sm">
